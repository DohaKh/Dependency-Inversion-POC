...
{
    /*
     * higher-level class to perform some kind of statistical analysis on our employees 
     * Well, first of all, our EmployeeStatistics class has a strong relation (coupled) to the EmployeeManager class 
     * and we can’t send any other object in the EmployeeStatistics constructor except the EmployeeManager object. 
